...
3) Create an appropriate random price to display for each pizza(say 15 to 30 )no html element needed
4) Enter quantity is a text inputno need to give an id
5) Buy is a button input no nned to give it event listaner
